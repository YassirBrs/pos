...
class Reports_model extends CI_Model {
	...
	public function show_sales_report(){
		...
		if($q1->num_rows()>0){
			...
			echo "<tr>";
			echo "<td class='text-center text-danger' colspan=14>No Records Trouver</td>";
			echo "</tr>";
		}
	...
	public function show_sales_return_report(){
		...
		if($q1->num_rows()>0){
			...
			echo "<tr>";
			echo "<td class='text-center text-danger' colspan=13>No Records Trouver</td>";
			echo "</tr>";
		}
	...
	public function show_stock_report(){
		...
		if($q1->num_rows()>0){
			...
			echo "<tr>";
			echo "<td class='text-center text-danger' colspan=8>No Records Trouver</td>";
			echo "</tr>";
		}
...
//		$this->db->group_by("c.`item_id`");
	...
	public function supplier_payments_report(){
		...
		if($q1->num_rows()>0){
			...
			echo "<tr>";
			echo "<td class='text-center text-danger' colspan=6>No Records Trouver</td>";
			echo "</tr>";
		}
	...
	public function get_profit_loss_report(){
			...
			$this->db->select("b.tax_amt,b.item_id,a.item_name,COALESCE(sum(b.sales_qty),0) as sales_qty,b.purchase_price,
	...
	public function get_profit_by_item(){
		...
		/*$q1=$this->db->query("
			...
			$this->db->select("c.item_name,b.purchase_price");
	...
	public function get_profit_by_invoice(){
		...
		if($q1->num_rows()>0){
			...
			echo "<tr>";
			echo "<td class='text-center text-danger' colspan=7>No Records Trouver</td>";
			echo "</tr>";
		}
